<?php
session_start();
// Periksa apakah pengguna telah login dan apakah peran pengguna adalah Mahasiswa
if (!isset($_SESSION['username']) || $_SESSION['level'] !== 'Mahasiswa') {
    // Jika pengguna bukan Mahasiswa, alihkan ke halaman lain (misalnya halaman login)
        ...
        <table border="1">
            ...
            <tbody>
                ...
                while($data = mysqli_fetch_assoc($query)){
                    ...
                    echo "<td>".substr($data['isi_surat'], 0, 20)."</td>";
                    echo "</tr>";
